...
let x: One = 'hello'
let y = x as Two   // assigning a less specific type to y
let z = x as Three   // assigning a more specific type to z

// We can also use the angle brackets (<>) syntax to do the same thing
let d = <One>'world' 
let e = <string | number>'world'   // assigning a less specific type to e    
